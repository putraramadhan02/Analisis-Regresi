...
data <- data.frame(
  ...
  newspaper = c(83.04, 54.12, 83.16, 70.2, 70.08, 90, 28.2, 13.92, 1.2, 25.44,
                29.04, 4.8, 79.08, 8.64, 55.2, 63.48, 136.8, 66.96, 21.96,
                22.92, 64.08, 28.2, 59.52, 31.44, 21.96)
)
```
...
```{r}
library(readxl)
read_excel("C:/Users/Putera Ramadhan/OneDrive/Documents/Analisis Regresi/Minggu 2/Data/data_iklan.xlsx")
```
...
```{r}
library(readr)
read.csv2("C:/Users/Putera Ramadhan/OneDrive/Documents/Analisis Regresi/Minggu 2/Data/data_iklan.csv")
```
